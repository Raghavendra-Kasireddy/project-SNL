...
ladderesound = pygame.mixer.Sound("D:\\Python\\laddereffect.mpeg")
...
options_bg = pygame.transform.scale(pygame.image.load("D:\\Python\\options_bg.png").convert_alpha(),(600,800))
...
text_surface = pygame.font.SysFont("Arial", 30).render("Press 'R' to roll", True, (185, 80, 255))   
...
def roll():
    ...
    current_dice = dice
    text_surface = pygame.font.SysFont("Arial", 30).render(result_str, True, (185, 80, 255))
                ...
                if current_player == 1:
                    ...
                    if player_position_1 >= 100:
                        if player_position_1 > 100:
                            ...
                            position_1 = pygame.font.SysFont("Arial", 30).render(f"Player Position 1: {player_position_1}", True, (255,255,255))
                        if player_position_1 == 100:
                            position_1 = pygame.font.SysFont("Arial", 30).render("Congratulations! You win!", True, (255,255,255))
                            player_position_1 = 0
                            player_position_2 = 0
                    ...
                    if player_position_2 >= 100:
                        if player_position_2 > 100:
                                ...
                                position_2 = pygame.font.SysFont("Arial", 30).render(f"Player Position 2: {player_position_2}", True, (255,255,255))
                        if player_position_2 == 100:
                                position_2 = pygame.font.SysFont("Arial", 30).render("Congratulations! You win!", True, (255,255,255))
                                player_position_1 = 0
                                player_position_2 = 0
                                delay_and_ignore_input(1000)
                    if current_dice == 6:
